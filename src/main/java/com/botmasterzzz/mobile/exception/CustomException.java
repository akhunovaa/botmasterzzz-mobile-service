package com.botmasterzzz.mobile.exception;

import com.botmasterzzz.mobile.util.JacksonMapper;
import com.botmasterzzz.mobile.util.JacksonViews.AuthorizationEnablerView;
