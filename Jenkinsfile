            ...
            steps {
                ...
                script {
                    sshagent(credentials: ['second']) {
                        ...
                        sh 'ssh root@5.189.146.63 docker run -v /home/repository:/home/repository -v /etc/localtime:/etc/localtime --name botmasterzzz-mobile-service -d -p 0.0.0.0:8066:8066 --network=host --restart always leon4uk/botmasterzzz-mobile-service:1.0.0'
                    }
                }
            }
        }
